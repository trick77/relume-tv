...
function renderSetup(s) {
  ...
  app.innerHTML = `
    <div class="wrap">
      <div class="top"><div class="brand"><a href="https://github.com/trick77/relume-tv" target="_blank" rel="noopener noreferrer">re<span>lume</span>-tv</a></div><div class="ver">v${esc(s.version)}${s.firstRun ? " · first run" : ""}</div></div>
...
function renderDashboard(s) {
  ...
  app.innerHTML = `
    <div class="wrap">
      <div class="top"><div class="brand"><a href="https://github.com/trick77/relume-tv" target="_blank" rel="noopener noreferrer">re<span>lume</span>-tv</a></div><div class="ver">v${esc(s.version)}</div>
